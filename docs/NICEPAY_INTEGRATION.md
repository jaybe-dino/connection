...
최신 운영 현황: [OPERATIONS_NEXT.md](OPERATIONS_NEXT.md). 2026-09-15 도입가 50원 정책 이후, 2026-09-20부터 신규 검증 가입은 5,000원으로 확정됨. 과거 기록·발행 청구서는 기록 당시 금액 보존(022). 아래는 초기 구현 결정 기록.
