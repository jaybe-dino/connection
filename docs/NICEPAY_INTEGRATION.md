...
조사일: 2026-09-15. 상태: 가입당 5,000원 확정. 구독 플랜 제거·신규 검증 가입 집계 구현 및 로컬 검증 완료. 결제 주기·부가세 기준 확인 중. PG 결제/배포 전.
...
- 결제 주기(월말 합산 / 선충전 / 건별 결제): 사용자 답변 대기.
- 부가세 포함 여부: 사용자 답변 대기.
...
청구 기준 확정 전에는 실제 청구·정기청구를 활성화하지 않는다.
